package com.liweqnaun.latte.ec.icon.launcher;
...
import com.liweqnaun.latte.app.IUserChecker;
...
import com.liweqnaun.latte.ui.launcher.ScrollLauncherTag;
import com.liweqnaun.latte.util.storage.LattePreference;
import com.liweqnaun.latte.util.timer.BaseTimerTask;
import com.liweqnaun.latte.util.timer.ITimerListener;
...
public class LauncherDelegate extends LatteDelegate implements ITimerListener{
    ...
    private void checkIsShowScroll() {
        if(!LattePreference.getAppFlag(ScrollLauncherTag.HAS_FIRST_LAUNCHER_APP.name())) {
            ...
            //检查用户是否登录了APP
            AccountMangger.checkAccount(new IUserChecker() {
                @Override
